...
//        $pic_data = addslashes(file_get_contents($_FILES['cover']['name']));        
        ...
        $sql = "INSERT INTO discount ( description)
            VALUES ('$_POST[description]')";
            if ($conn->query($sql) === TRUE) {
                sleep(2);
                $msg="Discount added successully";
            } 
            else {
                $msg="Couldn't add  Discount";
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="row">                
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" id="description" placeholder="Discount Description" name="description">
                            </div>
                        </div>
