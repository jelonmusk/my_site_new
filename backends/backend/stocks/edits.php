  ...
  <body>
    ...
    <?php include '../header.php' ?>
        ...
        <div class="container" style="margin-top:50px;">
            ...
            <form action="edits_update.php" method="post" enctype="multipart/form-data" id="edit_form">
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="book_id" placeholder="Book ID" name="book_id" value="<?php echo $book_id; ?>">
                            ...
                            <div class="row">
                                <div class="col-md-6">    
                                    ...
                                    <input type="text" class="form-control" id="copies" placeholder="No. Of Copies" name="copies" value="<?php echo $copies; ?>">
                ...
                <div class="row">
                    <div class="alert alert-danger" role="alert">
                      Entered ID doesnt exist  in the Database. Click <a href='manages.php'>here to go back</a>
                    </div>
                </div>
            </div>
         </div>
