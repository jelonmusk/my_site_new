...
//        $pic_data = addslashes(file_get_contents($_FILES['cover']['name']));        
        ...
        $sql = "INSERT INTO stocks ( book_id ,copies)
            VALUES ('$_POST[bookid]','$_POST[copies]')";
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="row">                
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="bookid" placeholder="Book ID" name="bookid">
                            </div>
                            <div class="col-md-6">
                                <label for="copies">No. Of Copies </label>
                                <input type="text" class="form-control" id="copies" placeholder="No. Of Copies" name="copies">
                            </div>
                        </div>
