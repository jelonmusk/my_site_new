...
if(isset($_GET['prod_id']))
{
    $conn_id=2;
    require('../connect.php');
    $sql= "SELECT * FROM e_stuff WHERE id= $_GET[prod_id]";
...
{
    header('location: http://localhost/my_site_new/index.php');
}
?>
<?php
if(isset($_GET['prod_id']))
                ...
                <div class="row">                    
                            ...
                            <div class="modal-content">
                                <form action="" method="post">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <a href="http://localhost/my_site/sign_in.php">Click here</a> to sign in.<br>
                                        New here? <a href="http://localhost/my_site/register.php">Click here</a> to register.
                                    </div>
                                ...
                                <form action="" method="post">
                                    ...
                                    <div class="modal-body">
                                        <div class="container">
                                            <div class="row">
                                                <div class="col-md-8">
                                                    <p style="font-weight:600;"><?php echo $item; ?></p>
                    ...
                    <script>
                        function send_data()
                        {
                            ...
                            window.location.href = '../create_order.php?prod_id='+prod_id+'&quantity='+quantity+'&product=e_stuff';
                    ...
                    <div class="col-md-8 book_details">
                        ...
                        <div class="row description">
                            <p><?php 
                                $string = strip_tags($specification);
                            ...
                            <div class="modal fade" id="more_modal" tabindex="-1" role="dialog" aria-labelledby="title" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="title"><?php echo $item; ?></h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
...
<div class="col-md-2"></div>
        ...
        <section>            
            ...
            <script>
                $("#user_reviews").load("fetch_reviews?page=1&prod_id="+<?php  echo $_GET['prod_id']; ?>); /*Loading first page*/
                                        $('#pagination').bootpag({
                    ...
                    $('#user_reviews').load("fetch_reviews.php?page="+num+"&prod_id="+<?php  echo $_GET['prod_id']; ?>, function(response, status, xhr) {
                        if ( status == "error" ) {
